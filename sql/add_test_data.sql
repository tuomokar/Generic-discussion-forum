INSERT INTO Forum_user (username, password, info, admin, created, edited) VALUES ('admin', 'admin1pass#', 'Mysterious admin figure. Might bite.', TRUE, '2016-07-31', '2016-07-31');
INSERT INTO Forum_user (username, password, info, created, edited) VALUES ('user1', 'user1pass#', 'Man, 40-year-old, accountant', '2016-07-31', '2016-07-31');
INSERT INTO Forum_user (username, password, info, created, edited) VALUES ('user2', 'user2pass#', 'Woman, 41 years old, IT worker', '2016-07-31', '2016-07-31');
INSERT INTO Forum_user (username, password, info, created, edited) VALUES ('user3', 'user3pass#', 'Man, 39-year-old, drunk', '2016-07-31', '2016-07-31');
INSERT INTO Forum_user (username, password, info, created, edited) VALUES ('NonGenericRebel', 'rebel1pass#', 'Genericity sucks!', '2016-07-31', '2016-07-31');
...
INSERT INTO Membership (user_id, user_group_id, created) VALUES ('3', '1', '2016-07-31');
INSERT INTO Membership (user_id, user_group_id, created) VALUES ('5', '2', '2016-07-31');
...
INSERT INTO Thread (topic_group_id, title, created, edited) VALUES ('2', 'The forum isn''t really even generic..', '2016-07-31', '2016-07-31');
...
INSERT INTO Post (user_id, thread_id, message, created, edited) VALUES ('2', '1', 'Generic second post here.', '2016-08-01', '2016-08-02');


INSERT INTO Post (user_id, thread_id, message, created, edited) VALUES ('2', '2', 'Generic functions are so cool aren''t they?', '2016-07-31', '2016-08-01');
INSERT INTO Post (user_id, thread_id, message, created) VALUES ('3', '3', 'Trademarks suck!', '2016-07-31');
INSERT INTO Post (user_id, thread_id, message, created) VALUES ('5', '4', 'I mean, look at the site logo and info - "The generic.." - that''s kind of conflicting isn''it it? Genericity sucks anyway, why would you want to strive to be generic? What does it even mean? Or is this a troll site?', '2016-08-01');
